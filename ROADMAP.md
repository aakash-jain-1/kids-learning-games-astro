...
tap — see CONTEXT.md §5 rule 8); games from D onward adopt it.
...
| E | **Feeling Friends** | Social-emotional | "Show me happy" — tap the face / read a feeling. Opens the SEL domain (currently empty). Scope agreed 2026-08-17: tiers 1–2 face recognition + tier 3 situational vignettes. | Queued — designed |
...
| I | **Opposites Friends** | Cognitive (contrast / vocabulary) | "Big — which one is small?" Tap the opposite. Generalises the More Friends contrast to 10 pairs. Depends on the `flashcards.ts` Strong/Light pair fix (done 2026-08-17). | Queued — designed |
